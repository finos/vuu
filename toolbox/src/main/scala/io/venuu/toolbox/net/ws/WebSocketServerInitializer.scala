...
/**
  */
class WebSocketServerInitializer(factory: FrameHandlerFactory) extends ChannelInitializer[SocketChannel] {
...
override def initChannel(ch:SocketChannel) = {
    ...
    pipeline.addLast(new WebSocketServerHandler(factory));
}
}
