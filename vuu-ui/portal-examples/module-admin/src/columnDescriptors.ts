...
export const moduleColumnDescriptors: ColumnDescriptor[] = [
    ...
    { name: 'enabled', label: 'Enabled', heading: ['Remote Module Details'], serverDataType: 'boolean' },
    ...
    // { name: 'vuuLastUpdatedTimestamp', label: 'Last Updated', width: 200, heading: ['Vuu Connection Details'], serverDataType: 'epochtimestamp' }
]
