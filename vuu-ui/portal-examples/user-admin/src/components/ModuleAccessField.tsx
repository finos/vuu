...
import type { SelectedItemChangeHandler } from "@vuu-ui/vuu-ui-controls";
...
export const ModuleAccessField = ({
  ...
  const changeSelection = useCallback<SelectedItemChangeHandler>((items) => {
    ...
    onChange?.(next);
  }, [access, currentAssignments, onChange]);
