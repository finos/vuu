...
const SimpleContent = ({id}) => {
  useEffect(() => {
    ...
    return () => {
      console.log(`%cSimpleContent ${id} UNMOUNTED`,'color:brown;font-weight:bold;font-size: 16px')
    }
  },[])
...
export const SimpleComponent = ({id: idProp}) => {
    ...
    useEffect(() => {
        ...
        return () => {
          console.log(`%cSimpleComponent ${id} UNMOUNTED`,'color:brown;font-weight:bold;font-size: 16px')
        }
      },[])
