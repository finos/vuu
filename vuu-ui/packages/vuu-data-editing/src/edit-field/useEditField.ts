...
import type { TextFieldType } from "./EditField";

export interface EditFieldHookProps<
...
export const useEditField = <T extends string | number | boolean = string>({
    column,
    value,
    onEdit,
    textType,
    type = "string",
}: EditFieldHookProps<T>) => {
