...
const renderElectronPortal = (component, x, y, el, onRender) => {
  ...
  console.log(`currentPosition: x ${currentPosition.x} y ${currentPosition.y}, x,y ${x} ${y}`);
  ...
  ReactDOM.render(<ThemeProvider>{component}</ThemeProvider>, portalContainer, handleRender);
  return portalContainer;
};

export const renderPortal = electronAPI ? renderElectronPortal : renderDOMPortal;
