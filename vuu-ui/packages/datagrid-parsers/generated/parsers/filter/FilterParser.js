...
export class FilterParser extends Parser {
  ...
  static VOCABULARY = new VocabularyImpl(
    FilterParser._LITERAL_NAMES,
    FilterParser._SYMBOLIC_NAMES,
    []
  );
  // @Override
  // @NotNull
  ...
  // @Override
  get ruleNames() {
    return FilterParser.ruleNames;
  }
  // @Override
  get serializedATN() {
    return FilterParser._serializedATN;
  }
      ...
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        if (
          !(
            ...
            ((1 << _la) &
              ((1 << FilterParser.TRUE) |
                (1 << FilterParser.FALSE) |
                (1 << FilterParser.INT) |
                (1 << FilterParser.FLOAT) |
                (1 << FilterParser.INT_ABBR) |
                (1 << FilterParser.FLOAT_ABBR) |
                (1 << FilterParser.STRING) |
                (1 << FilterParser.ID))) !==
              0
          )
        ) {
      ...
      this.enterOuterAlt(_localctx, 1);
      {
        ...
        if (
          !(
            (_la & ~0x1f) === 0 &&
            ((1 << _la) &
              ((1 << FilterParser.CONTAINS) |
                (1 << FilterParser.STARTS) |
                (1 << FilterParser.ENDS))) !==
              0
          )
        ) {
  ...
  static _serializedATN =
    '\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x03\x1F\x92\x04\x02' +
    ...
    '\x02\x02IQ\x05\x0E\b\x02JQ\x05\f\x07\x02KQ\x05"\x12\x02LM\x07\x13\x02' +
    '\x02MN\x05\x04\x03\x02NO\x07\x14\x02\x02OQ\x03\x02\x02\x02PI\x03\x02\x02' +
    ...
    '\x02\x02UV\x03\x02\x02\x02VW\x07\f\x02\x02WX\x07\x11\x02\x02XY\x05\x16' +
    '\f\x02YZ\x07\x12\x02\x02Z\r\x03\x02\x02\x02[_\x05\x10\t\x02\\_\x05\x12' +
    ...
    '\r\x02k\x15\x03\x02\x02\x02lq\x05\x18\r\x02mn\x07\x15\x02\x02np\x05\x18' +
    ...
    '\x02\x02\x02vw\x07\x1D\x02\x02w\x1B\x03\x02\x02\x02xy\x07\x1C\x02\x02' +
    'y\x1D\x03\x02\x02\x02z{\x07\x1E\x02\x02{\x1F\x03\x02\x02\x02|}\x07\x1E' +
    '\x02\x02}!\x03\x02\x02\x02~\x7F\x07\x16\x02\x02\x7F\x80\x07\x1E\x02\x02' +
  ...
  static get _ATN() {
    if (!FilterParser.__ATN) {
      FilterParser.__ATN = new ATNDeserializer().deserialize(
        Utils.toCharArray(FilterParser._serializedATN)
      );
    }
...
export class ExpressionContext extends ParserRuleContext {
  ...
  // @Override
  get ruleIndex() {
    return FilterParser.RULE_expression;
  }
  // @Override
  enterRule(listener) {
...
export class Or_expressionContext extends ParserRuleContext {
  ...
  // @Override
  get ruleIndex() {
    return FilterParser.RULE_or_expression;
  }
  // @Override
  enterRule(listener) {
...
export class And_expressionContext extends ParserRuleContext {
  ...
  // @Override
  get ruleIndex() {
    return FilterParser.RULE_and_expression;
  }
  // @Override
  enterRule(listener) {
...
export class As_clauseContext extends ParserRuleContext {
  AS() {
    return this.getToken(FilterParser.AS, 0);
  }
  filtername() {
  ...
  // @Override
  get ruleIndex() {
    return FilterParser.RULE_as_clause;
  }
  // @Override
  enterRule(listener) {
...
export class TermContext extends ParserRuleContext {
  ...
  LPAREN() {
    return this.tryGetToken(FilterParser.LPAREN, 0);
  }
  or_expression() {
    return this.tryGetRuleContext(0, Or_expressionContext);
  }
  RPAREN() {
    return this.tryGetToken(FilterParser.RPAREN, 0);
  }
  constructor(parent, invokingState) {
    super(parent, invokingState);
  }
...
export class Col_set_expressionContext extends ParserRuleContext {
  ...
  // @Override
  get ruleIndex() {
    return FilterParser.RULE_col_set_expression;
  }
  // @Override
  enterRule(listener) {
...
export class Col_val_expressionContext extends ParserRuleContext {
  ...
  // @Override
  get ruleIndex() {
    return FilterParser.RULE_col_val_expression;
  }
  // @Override
  enterRule(listener) {
...
export class Numeric_col_val_expressionContext extends ParserRuleContext {
  ...
  // @Override
  get ruleIndex() {
    return FilterParser.RULE_numeric_col_val_expression;
  }
  // @Override
  enterRule(listener) {
...
export class String_col_val_expressionContext extends ParserRuleContext {
  ...
  // @Override
  get ruleIndex() {
    return FilterParser.RULE_string_col_val_expression;
  }
  // @Override
  enterRule(listener) {
...
export class Default_col_val_expressionContext extends ParserRuleContext {
  ...
  // @Override
  get ruleIndex() {
    return FilterParser.RULE_default_col_val_expression;
  }
  // @Override
  enterRule(listener) {
...
export class AtomsContext extends ParserRuleContext {
  ...
  // @Override
  get ruleIndex() {
    return FilterParser.RULE_atoms;
  }
  // @Override
  enterRule(listener) {
...
export class AtomContext extends ParserRuleContext {
  ID() {
    return this.tryGetToken(FilterParser.ID, 0);
  }
  INT() {
    return this.tryGetToken(FilterParser.INT, 0);
  }
  FLOAT() {
    return this.tryGetToken(FilterParser.FLOAT, 0);
  }
  STRING() {
    return this.tryGetToken(FilterParser.STRING, 0);
  }
  TRUE() {
    return this.tryGetToken(FilterParser.TRUE, 0);
  }
  FALSE() {
    return this.tryGetToken(FilterParser.FALSE, 0);
  }
  INT_ABBR() {
    return this.tryGetToken(FilterParser.INT_ABBR, 0);
  }
  FLOAT_ABBR() {
    return this.tryGetToken(FilterParser.FLOAT_ABBR, 0);
  }
  constructor(parent, invokingState) {
    super(parent, invokingState);
  }
...
export class Numeric_columnContext extends ParserRuleContext {
  ID_NUMERIC() {
    return this.getToken(FilterParser.ID_NUMERIC, 0);
  }
  constructor(parent, invokingState) {
    super(parent, invokingState);
  }
  // @Override
  get ruleIndex() {
    return FilterParser.RULE_numeric_column;
  }
  // @Override
  enterRule(listener) {
...
export class String_columnContext extends ParserRuleContext {
  ID_STRING() {
    return this.getToken(FilterParser.ID_STRING, 0);
  }
  constructor(parent, invokingState) {
    super(parent, invokingState);
  }
  // @Override
  get ruleIndex() {
    return FilterParser.RULE_string_column;
  }
  // @Override
  enterRule(listener) {
...
export class ColumnContext extends ParserRuleContext {
  ...
  // @Override
  get ruleIndex() {
    return FilterParser.RULE_column;
  }
  // @Override
  enterRule(listener) {
...
export class FilternameContext extends ParserRuleContext {
  ...
  // @Override
  get ruleIndex() {
    return FilterParser.RULE_filtername;
  }
  // @Override
  enterRule(listener) {
...
export class Named_filterContext extends ParserRuleContext {
  COLON() {
    return this.getToken(FilterParser.COLON, 0);
  }
  ID() {
    return this.getToken(FilterParser.ID, 0);
  }
  ...
  // @Override
  get ruleIndex() {
    return FilterParser.RULE_named_filter;
  }
  // @Override
  enterRule(listener) {
...
export class String_operatorContext extends ParserRuleContext {
  ...
  // @Override
  get ruleIndex() {
    return FilterParser.RULE_string_operator;
  }
  // @Override
  enterRule(listener) {
...
export class Numeric_operatorContext extends ParserRuleContext {
  ...
  // @Override
  get ruleIndex() {
    return FilterParser.RULE_numeric_operator;
  }
  // @Override
  enterRule(listener) {
...
export class Equality_operatorContext extends ParserRuleContext {
  EQ() {
    return this.tryGetToken(FilterParser.EQ, 0);
  }
  NEQ() {
    return this.tryGetToken(FilterParser.NEQ, 0);
  }
  constructor(parent, invokingState) {
    super(parent, invokingState);
  }
  // @Override
  get ruleIndex() {
    return FilterParser.RULE_equality_operator;
  }
  // @Override
  enterRule(listener) {
...
export class Comparison_operatorContext extends ParserRuleContext {
  LT() {
    return this.tryGetToken(FilterParser.LT, 0);
  }
  GT() {
    return this.tryGetToken(FilterParser.GT, 0);
  }
  constructor(parent, invokingState) {
    super(parent, invokingState);
  }
  // @Override
  get ruleIndex() {
    return FilterParser.RULE_comparison_operator;
  }
  // @Override
  enterRule(listener) {
...
export class Substring_operatorContext extends ParserRuleContext {
  STARTS() {
    return this.tryGetToken(FilterParser.STARTS, 0);
  }
  ENDS() {
    return this.tryGetToken(FilterParser.ENDS, 0);
  }
  CONTAINS() {
    return this.tryGetToken(FilterParser.CONTAINS, 0);
  }
  constructor(parent, invokingState) {
    super(parent, invokingState);
  }
  // @Override
  get ruleIndex() {
    return FilterParser.RULE_substring_operator;
  }
  // @Override
  enterRule(listener) {
...
export class OperatorContext extends ParserRuleContext {
  ...
  // @Override
  get ruleIndex() {
    return FilterParser.RULE_operator;
  }
  // @Override
  enterRule(listener) {
