...
term : col_val_expression | col_set_expression | named_filter | LPAREN or_expression RPAREN;

col_set_expression: (column | string_column) IN LBRACK atoms RBRACK;

col_val_expression: numeric_col_val_expression | string_col_val_expression | default_col_val_expression;

numeric_col_val_expression: numeric_column numeric_operator atom;
...
atom : ID | INT | FLOAT | STRING | TRUE | FALSE | INT_ABBR | FLOAT_ABBR;
