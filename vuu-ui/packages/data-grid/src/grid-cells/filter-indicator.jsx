...
import { filterIncludesColumn } from '@vuu-ui/utils';
...
export const FilterIndicator = ({ column, filter }) => {
  const hasFilter = useMemo(() => filterIncludesColumn(filter, column), [filter, column]);
  ...
  return (
    <div className={cx('hwFilterIndicator')} data-icon="filter" onClick={handleClick}>
