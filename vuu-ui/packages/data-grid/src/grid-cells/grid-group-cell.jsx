...
/** @type {GroupCellType} */
export const GroupCell = React.memo(function GroupCell({ column, row, toggleStrategy }) {
  ...
  const allowToggle = toggleStrategy.expand_level_1 !== false || row[DEPTH] !== 1;
  ...
  return (
    ...
    >
      {offset !== null ? (
        <div className={'GridGroupCell'} style={{ paddingLeft: (offset - 1) * 20 }} tabIndex={0}>
          {allowToggle ? <span className="hwIconContainer" data-icon={'arrow-right'} /> : null}
