...
export const Tabstrip = forwardRef(function Tabstrip(
  ...
  const className = cx(
    ...
    classNameProp,
    {
      [`${classBase}-centered`]: centered,
      [`${classBase}-draggingTab`]: tabstripHook.isDragging,
      [`${classBase}-tertiary`]: variant === "tertiary",
    }
  );
  ...
  return (
    <div
      ...
      role="tablist"
    >
      <div className={`${classBase}-tertiary`} ref={innerContainerRef}>
        {renderContent()}
      </div>
