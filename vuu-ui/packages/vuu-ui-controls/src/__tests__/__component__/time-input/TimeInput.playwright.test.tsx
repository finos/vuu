  ...
  test.describe("focus management", () => {
    test.describe("WHEN focus enters control via keyboard, forwards", () => {
      test("THEN control is focused and hours are selected", async ({
        ...
        const selectionStart = await timeinput.evaluate(
          (el) => (el as HTMLInputElement).selectionStart,
        );
        const selectionEnd = await timeinput.evaluate(
          (el) => (el as HTMLInputElement).selectionEnd,
        );
      ...
      test.describe("WHEN left/right arrow keys used", () => {
        test("THEN right arrow key shifts selection right", async ({
          ...
          test.skip(
            ...
            "Selection range testing needs more investigation in Firefox and WebKit",
          );
