...
describe("ServerProxy", () => {
  describe("subscription", () => {
    ...
    it("initialises Viewport when server ACKS subscription", () => {
      ...
      expect(serverProxy.viewports.size).toEqual(1);
      expect(serverProxy.mapClientToServerViewport.get("client-vp-1")).toEqual(
        "server-vp-1"
      );
    ...
    it("10 rows in grid, so 11 requested, (render buffer 0), 10 rows in Viewport buffer, page down, narrowing of range by 1 row", () => {
      ...
      expect(postMessageToClient).toHaveBeenCalledWith({
        ...
        rows: [
          ...
          [8,8,true,null,null,1,"key-08",0,"key-08","name 08",1008,true],
          [9,9,true,null,null,1,"key-09",0,"key-09","name 09",1009,true],
          [10,10,true,null,null,1,"key-10",0,"key-10","name 10",1010,true],
        ],
        size: 100,
      });
      ...
      expect(postMessageToClient).toHaveBeenCalledWith({
        ...
        clientViewportId: "client-vp-1",
        rows: [
          [11,8,true,null,null,1,"key-11",0,"key-11","name 11",1011,true],
          [12,7,true,null,null,1,"key-12",0,"key-12","name 12",1012,true],
          [13,6,true,null,null,1,"key-13",0,"key-13","name 13",1013,true],
          [14,5,true,null,null,1,"key-14",0,"key-14","name 14",1014,true],
          [15,4,true,null,null,1,"key-15",0,"key-15","name 15",1015,true,],
          [16,3,true,null,null,1,"key-16",0,"key-16","name 16",1016,true],
          [17,2,true,null,null,1,"key-17",0,"key-17","name 17",1017,true],
          [18,1,true,null,null,1,"key-18",0,"key-18","name 18",1018,true],
          [19,0,true,null,null,1,"key-19",0,"key-19","name 19",1019,true],
        ],
      });
    });
