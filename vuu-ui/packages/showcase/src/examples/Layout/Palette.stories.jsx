...
import { registerComponent, Component, Palette, PaletteItem, Toolbar, View } from '@vuu-ui/layout';
...
export const StructuredPalette = () => (
  ...
  >
    <Palette collapsibleHeaders orientation="vertical" style={{ width: '100%', height: '100%' }}>
