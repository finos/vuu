        ...
        <Chest style={{ flex: 1 }}>
          <Drawer clickToOpen peekaboo position="left" inline sizeOpen={150} toggleButton="end">
            <View header title="View Tables">
              <Palette collapsibleHeaders orientation="vertical" style={{ width: 150, flex: 1 }}>
                ...
                <PaletteItem title="2 Columns" template closeable resizeable header>
                  {layout.twoColumns}
                </PaletteItem>
                <div data-header>Tables</div>
                <PaletteItem title="Instruments" header>
                  <Component style={{ backgroundColor: 'rgba(0,0,255,.3)', height: '100%' }} />
                </PaletteItem>
                <PaletteItem title="Brown Sugar" closeable resizeable header>
                  <Component style={{ backgroundColor: 'rgba(255,0,0,.5)', height: '100%' }} />
                </PaletteItem>
                <PaletteItem title="Green Day" closeable resizeable header>
                  <Component style={{ backgroundColor: 'rgba(0,255,0,.5)', height: '100%' }} />
                </PaletteItem>
                <PaletteItem title="Lemonheads" closeable resizeable header>
                  <Component style={{ backgroundColor: 'rgba(255,255,0,.4)', height: '100%' }} />
                </PaletteItem>
              </Palette>
            </View>
          </Drawer>
          <DraggableLayout style={{ width: '100%', height: '100%' }} dropTarget>
            <Stack style={{ width: '100%', height: '100%' }} enableAddTab preserve showTabs>
