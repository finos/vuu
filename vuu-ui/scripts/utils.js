...
module.exports.bumpDependencies = (pathToPackage) => {
...
module.exports.readPackageJson = (path = 'package.json') => {
...
module.exports.formatBytes = (bytes, decimals = 2, displayLength = 10) => {
