...
import { useServerSideRowModel } from "@finos/vuu-data-ag-grid";
...
export const AgGridInstruments = () => {
  ...
  const { createFilterDataProvider, ...gridConfig } = useServerSideRowModel(
...
export const AgGridInstrumentsGrouped = () => {
  ...
  const { createFilterDataProvider, ...gridConfig } =
    useServerSideRowModel(dataConfig);
