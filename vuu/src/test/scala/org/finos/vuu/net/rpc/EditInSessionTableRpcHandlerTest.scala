...
class EditInSessionTableRpcHandlerTest extends AnyFeatureSpec with Matchers with BeforeAndAfterEach {
  private var handler: EditInSessionTableRpcHandler = _
  ...
  override def beforeEach(): Unit = {
    ...
    handler = new EditInSessionTableRpcHandler()
  }
