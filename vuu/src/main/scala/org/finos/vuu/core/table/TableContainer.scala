...
class TableContainer(val joinTableProvider: JoinTableProvider)(implicit val metrics: MetricsProvider, val clock: Clock) extends JmxAble with TableContainerMBean with StrictLogging {
