...
/**
 * This trait allows us to abstract the processing logic for a particular viewport. This processing logic is returned as a futuretask/callable
 * to an executor to run.
 *
 * See VuuServer.scala to look at the construction of these executors.
 */
trait ViewPortTreeCallableFactory {
