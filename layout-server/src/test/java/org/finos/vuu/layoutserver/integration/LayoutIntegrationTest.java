...
public class LayoutIntegrationTest {
    ...
    private static final UUID DEFAULT_LAYOUT_ID = UUID.fromString(
    ...
    void getLayout_validIDAndLayoutExists_returns200WithLayout() throws Exception {
        ...
        Map<String, Object> definition = objectMapper.convertValue(layout.getDefinition(),
            Map.class);
    ...
    void getMetadata_multipleMetadataExists_returnsAllMetadata() throws Exception {
        ...
        layout2.setDefinition(
            objectNodeConverter.convertToEntityAttribute(UPDATED_LAYOUT_DEFINITION_STRING));
    ...
    void createLayout_validRequest_returnsCreatedLayoutAndLayoutIsPersisted()
        ...
        Map<String, Object> definition = objectMapper.convertValue(layoutRequest.getDefinition(),
            Map.class);
    ...
    private Layout createDefaultLayoutInDatabase() {
        ...
        layout.setDefinition(
            objectNodeConverter.convertToEntityAttribute(DEFAULT_LAYOUT_DEFINITION_STRING));
