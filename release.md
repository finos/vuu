...
2. Go to [Actions](https://github.com/finos/vuu/actions) -> [Create release branch and tag](https://github.com/finos/vuu/actions/workflows/create-release.yml). Click "Run workflow" and manually fill in the release version (e.g. 0.1.23) and the new snapshot version (e.g. 0.1.24-SNAPSHOT). Click the green button "Run workflow".
